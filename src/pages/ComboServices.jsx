...
export default function ComboServices() {
  ...
  const prepaidCards = [
    { id: 1, title: 'COMBO 1500', price: '1,500 ֏ / ամիս', internet: '10 ԳԲ', calls: '1500 րոպե', sms: '150 SMS', apps: socialAppsList },
    { id: 2, title: 'COMBO 2500', price: '2,500 ֏ / ամիս', internet: '20 ԳԲ', calls: '2500 րոպե', sms: '250 SMS' },
    { id: 3, title: 'COMBO 3500', price: '3,500 ֏ / ամիս', internet: '40 ԳԲ', calls: '3500 րոպե', sms: '350 SMS' },
    { id: 4, title: 'COMBO 5500', price: '5,500 ֏ / ամիս', internet: 'Անսահմանափակ', calls: '5500 րոպե', sms: '500 SMS', apps: socialAppsList },
  ];

  const postpaidCards = [
    { id: 1, title: 'COMBO Be free 1900', price: '1,900 ֏ / ամիս', internet: '15 ԳԲ', calls: '2000 րոպե', sms: '200 SMS', apps: socialAppsList },
    { id: 2, title: 'COMBO Be free 2900', price: '2,900 ֏ / ամիս', internet: '30 ԳԲ', calls: '3000 րոպե', sms: '300 SMS' },
    { id: 3, title: 'COMBO Be free 4900', price: '4,900 ֏ / ամիս', internet: 'Անսահմանափակ', calls: '4500 րոպե', sms: '450 SMS' },
  ];
  ...
  return (
    <div className="space-y-8 pb-12">
      <section className="w-full h-[350px] md:h-[450px] overflow-hidden bg-[#EBE7E0]">
        <img
          src="https://www.telecomarmenia.am/images/menu/1/17488638560003.png"
          alt="Combo Services"
      ...
      <div className="flex justify-center -mt-20 relative z-10 px-4">
        <div className="bg-white border border-gray-100 shadow-xl rounded-none px-6 py-5 flex items-center justify-center gap-6 md:gap-10 hover:shadow-2xl transition duration-300">
          <div className="flex flex-col items-center space-y-2 cursor-pointer group">
            ...
            <span className="text-sm font-bold text-[#004B6E]">ինտերնետ և TV</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-2 cursor-pointer group">
            ...
            <span className="text-sm font-bold text-[#004B6E]">Team TV</span>
          </div>
          ...
          <div className="flex flex-col items-center space-y-2 cursor-pointer group">
            ...
            <span className="text-sm font-bold text-[#004B6E]">Ինտերնետ և TV ԿՈՄԲՈ</span>
          </div>
        </div>
      </div>
            ...
            <div className="flex flex-col w-full space-y-3">
              <button
                ...
                className={`w-full py-3 px-4 rounded-xl font-bold text-base transition-all ${
                  activePackage === 'prepaid' ? 'bg-[#004B6E] text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                }`}
              >
                COMBO
              </button>
              <button
                ...
                className={`w-full py-3 px-4 rounded-xl font-bold text-base transition-all ${
                  activePackage === 'postpaid' ? 'bg-[#004B6E] text-white shadow-md' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                }`}
              >
                COMBO Be free
              </button>
          ...
          <div className="w-full lg:w-3/4 flex flex-col pt-4 space-y-6">
            <div className="border-b-2 border-gray-300 pb-2 flex justify-start gap-8">
              <button
                ...
                className={`font-bold text-lg pb-3 transition-colors ${
                  activePackage === 'prepaid' ? 'text-[#004B6E] border-b-4 border-[#004B6E]' : 'text-gray-400 hover:text-gray-600'
                }`}
              >
                Կանխավճարային
              </button>
              <button
                onClick={() => setActivePackage('postpaid')}
                className={`font-bold text-lg pb-3 transition-colors ${
                  activePackage === 'postpaid' ? 'text-[#004B6E] border-b-4 border-[#004B6E]' : 'text-gray-400 hover:text-gray-600'
                }`}
              >
                Հետվճարային
              </button>
            ...
            <div className="flex flex-col space-y-4">
              {(activePackage === 'prepaid' ? prepaidCards : postpaidCards).map((card) => {
                ...
                return (
                  <div key={card.id} className="relative w-full bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden">
                    <button
                      onClick={() => (isInCart ? removeFromCart(card.title) : addToCart(card))}
                      ...
                      <div className="bg-gray-50/70 border-t border-gray-100 px-6 py-2 flex items-center gap-3">
                        ...
                        <div className="flex items-center gap-2.5">
                          {card.apps.map((appName) => (
                            <div key={appName} className="p-1 bg-white rounded-md shadow-2xs border border-gray-100 flex items-center justify-center hover:scale-110 transition-transform" title={appName}>
                              {socialIcons[appName]}
                            </div>
                          ))}
                        </div>
